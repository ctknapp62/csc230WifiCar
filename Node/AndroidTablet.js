...
//app.get('/drive/:dir/', function(req, res) {
    ...
    //var newSpeed = req.praams.dir.speed;
    //if (driveDirection == 'Forward') {
      //if(driveSpeed > 94 && newSpeed > driveSpeed){
